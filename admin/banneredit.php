    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		  ...
		  <li><a href="bannerlist.php">Imágenes</a></li>
		  <li class="active">Editar</li>
		</ol>
		 <div class="col-md-7">
		 <h5 ><span class="glyphicon glyphicon-edit"></span> Editar imágen</h5>
		...
		<div class="col-md-5">
		 <h5 ><span class="glyphicon glyphicon-picture"></span> Imagen</h5>
				...
				<div class="col-sm-12">
				 ...
				 <div class="fileinput fileinput-new" data-provides="fileinput">
								  <div class="fileinput-new thumbnail" style="max-width: 100%;" >
									  <img class="img-rounded" src="../img2/banner/<?php echo $url_image;?>" />
								  </div>
